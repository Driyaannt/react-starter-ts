  ...
  React.useEffect(() => {
    const handleDropdownClick = (event: Event) => {
      ...
      if (trigger) {
        ...
        setTimeout(() => {
          const dropdowns = document.querySelectorAll('[data-radix-dropdown-menu-content][data-state="open"]');
    ...
    return () => document.removeEventListener('click', handleDropdownClick, true);
  }, []);
